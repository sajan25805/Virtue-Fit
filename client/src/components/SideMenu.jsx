...
const SideMenu = ({ children }) => {
  ...
  return (
    <div className="flex h-screen">
      {/* Main Content */}
      <div className="flex-1 relative overflow-auto">
        {children || <div className="py-40">{/* Main content goes here */}</div>}
      </div>
...
const SideMenuButton = ({ labelName, Icon, showLabel, isActive, to }) => {
  return (
    <Link to={to} className="block">
      <div
        className={`w-full cursor-pointer px-2 py-2 rounded-md flex items-center ${
          isActive
            ? "bg-[#00A8FF] bg-opacity-20 border-l-4 border-[#00A8FF]"
            : "hover:bg-white/10"
        }`}
        ...
        {showLabel && (
          <p
            className={`text-sm font-medium ml-3 ${
              isActive ? "text-[#00A8FF]" : "text-white"
            }`}
          >
            {labelName}
          </p>
...
// Navigation Sections
const MainNavigation = [
  { id: 1, iconName: CalendarIcon, labelName: "Planner", path: "/planner" },
  { id: 2, iconName: UserCircleIcon, labelName: "Workout", path: "/workout" },
  { id: 3, iconName: CubeTransparentIcon, labelName: "Program", path: "/program" },
  { id: 4, iconName: ListBulletIcon, labelName: "Meditation", path: "/meditation" },
];

const Eat = [
  { id: 1, iconName: FaceSmileIcon, labelName: "Meal", path: "/meal" },
  { id: 2, iconName: BookOpenIcon, labelName: "Snacks", path: "/snack" },
];

const Live = [];

const Tools = [
  { id: 1, iconName: Cog6ToothIcon, labelName: "Settings", path: "/settings" },
  { id: 2, iconName: QuestionMarkCircleIcon, labelName: "Help", path: "/help" },
  { id: 3, iconName: BookOpenIcon, labelName: "My Plan", path: "/subscription" },
];
